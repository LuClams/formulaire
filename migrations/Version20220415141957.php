 ...
 */
final class Version20220415141957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP ad, CHANGE amount amount DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD ad VARCHAR(255) DEFAULT \'NULL\', CHANGE amount amount DOUBLE PRECISION DEFAULT \'NULL\'');
